...
INSERT INTO `user` VALUES (1,'root','localhost','2018-06-21','12345678','1234@ims.com',')}‚\Õ`“\Äú{`\ÆRj\Ú\ï','£ÿ™†8\Òý\ì\Øv–I,+\ä`£aË¢',1,'','1 Main Street','complex',1),(2,'Neerav','Panchal','1996-07-26','0711231234','nsp@ims.com','<‡\×z\èR3Ü¢\ÆF†g‚£&©N','{¿P¥C\Ò\æþ(o\Ç;uÇ‡z\Í(',1,'','1 Main','House 101',1),(3,'Mauritz','Langeveld','2018-06-21','12345','m@ims.com','\Æ\é\Üf»©šE\Ö/h¯E\nNcä¾¼','d\Æó—³l\ãb$ñ\Ñ.]ŽÀø\ÑN',1,'','1 mains','House 1',2),(4,'Mehul','Panchal','2000-09-28','0711231234','mehul@ims.com','v\Ñ1\re9©a\ÇqLdþh25\Ú/;','\Â\Ã\ì\Ía2%û·•k” 3/˜³x;',2,'','4 Scanlan','Street',1),(5,'Nirmal','Gajjar','1988-11-11','0713214321','nirmal@ims.com','8@\Õ\Ív3=vò\Z÷—™;µœƒ7','2²Ø@…\Å)¸‡YÁ¼DŽûC·',3,'','6 Scanlan','Street',2);
...
/*!50003 SET sql_mode              = 'NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`root`@`localhost` PROCEDURE `uspUserPassword_OldCheck`(IN userID int,IN pWord varchar(50))
BEGIN
...
/*!50003 SET sql_mode              = 'NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`root`@`localhost` PROCEDURE `uspUserPassword_UpdatePass`(IN userID int,IN pWord varchar(50))
BEGIN
	DECLARE errno INT;
	DECLARE EXIT HANDLER FOR SQLEXCEPTION
	BEGIN
...
/*!50003 SET sql_mode              = 'NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`root`@`localhost` PROCEDURE `uspUserSetting_SpecificUser`(IN id int)
BEGIN
...
/*!50003 SET sql_mode              = 'NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`root`@`localhost` PROCEDURE `uspUserSetting_Suburbs`()
BEGIN
...
/*!50003 SET sql_mode              = 'NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`root`@`localhost` PROCEDURE `uspUserSetting_Update`(
IN userID int,
IN firstName varchar(45),
IN lastName varchar(45),
IN dob varchar(10),
...
-- Dump completed on 2018-06-27 16:38:04
