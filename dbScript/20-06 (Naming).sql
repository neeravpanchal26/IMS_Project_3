...
--
-- Host: 127.0.0.1
-- Generation Time: Jun 20, 2018 at 09:34 AM
...
-- Procedures
--
CREATE DEFINER=`root`@`localhost` PROCEDURE `uspAddEquipment` ()  BEGIN
INSERT INTO equipment (EquipmentID, EquipmentDesc, LocationGps, LocationPerson, EquipmentCost, 
EquipmentCondition, EquipmentBrand, Section, EquipmenType, Status, ConditionPicture, DateReceived)
VAlues(EquipmentID, EquipmentDesc, LocationGps, LocationPerson, EquipmentCost, 
EquipmentCondition, EquipmentBrand, Section, EquipmenType, Status, ConditionPicture, DateReceived);
...
CREATE TABLE `business` (
  ...
  `BusinessLogo` blob,
  `BusinessContact` varchar(45) DEFAULT NULL,
...
INSERT INTO `section` (`SectionID`, `Desc`) VALUES
(1, 'Electrical'),
(2, 'Machanical');
...
INSERT INTO `status` (`StatusID`, `Desc`) VALUES
(1, 'Assigned'),
(2, 'Un-assigned'),
(3, 'Installed');
...
INSERT INTO `usertype` (`UserTypeID`, `Desc`) VALUES
(1, 'IT Technicain'),
...
ALTER TABLE `equipment`
  ...
  ADD KEY `brandID_idx` (`EquipmentBrand`),
  ADD KEY `typeID_idx` (`EquipmentType`),
...
--
ALTER TABLE `equipment`
  ADD CONSTRAINT `brandID` FOREIGN KEY (`EquipmentBrand`) REFERENCES `brand` (`BrandID`) ON DELETE NO ACTION ON UPDATE NO ACTION,
  ...
  ADD CONSTRAINT `subTypeID` FOREIGN KEY (`EquipmentType`) REFERENCES `subtype` (`SubTypeID`) ON DELETE NO ACTION ON UPDATE NO ACTION,
